...
async function main() {
  ...
  await prisma.moodRule.createMany({
    data: [
      { name: "Morning Fresh", condition: { weather: [], timeRange: ["06:00", "10:00"] }, theme: { mode: "light", primary: "#10B981", accent: "#A7F3D0", bg: "#ECFDF5", text: "#064E3B" }, featuredTags: ["breakfast", "coffee", "fresh"], priority: 5, restaurantId: restaurant.id },
      { name: "Rainy Day Comfort", condition: { weather: ["Rain", "Drizzle", "Thunderstorm"] }, theme: { mode: "dark", primary: "#F97316", accent: "#FDE68A", bg: "#1C1917", text: "#FAFAF9" }, featuredTags: ["hot", "comfort", "soup"], priority: 4, restaurantId: restaurant.id },
      { name: "Sunny Energy", condition: { weather: ["Clear"] }, theme: { mode: "light", primary: "#06B6D4", accent: "#A5F3FC", bg: "#ECFEFF", text: "#164E63" }, featuredTags: ["cold", "refreshing", "iced"], priority: 3, restaurantId: restaurant.id },
      { name: "Cloudy Chill", condition: { weather: ["Clouds", "Mist", "Fog", "Haze"] }, theme: { mode: "light", primary: "#8B5CF6", accent: "#DDD6FE", bg: "#FAF5FF", text: "#4C1D95" }, featuredTags: ["warm", "tea", "snack"], priority: 2, restaurantId: restaurant.id },
      { name: "Late Night Vibes", condition: { weather: [], timeRange: ["21:00", "05:00"] }, theme: { mode: "dark", primary: "#EC4899", accent: "#FBCFE8", bg: "#0F172A", text: "#F8FAFC" }, featuredTags: ["special", "dessert", "popular"], priority: 1, restaurantId: restaurant.id },
    ],
  });
