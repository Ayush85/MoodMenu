...
export default function AdminSidebar() {
  ...
  return (
    ...
    >
      ...
      <nav className="flex gap-2 overflow-x-auto pb-1 md:flex-1 md:block md:space-y-1 md:overflow-visible md:pb-0">
        {links.map((link) => (
          <NavLink
            ...
            accentIconClassName="text-red-400"
            indicatorGradient="from-red-500 to-rose-500"
            indicatorClassName="hidden md:block"
            icon={
      ...
      <div className="hidden md:block border-t border-white/6 pt-4 mt-4 space-y-1">
        <Link
          href="/dashboard"
          className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-gray-400 hover:text-white hover:bg-white/4 transition text-sm"
        >
          <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
